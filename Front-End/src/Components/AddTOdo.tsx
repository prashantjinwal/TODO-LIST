  ...
  return (
    <>
        ...
        <form onSubmit={HandFormSubmit}>
            ...
            <input type="text" className="bg-[#302f2f] pl-4 mr-2 lg:w-[30em] w-[14em] md:w-[18em] outline-0  border-0 " placeholder="Task name" value={todo} onChange={(e) => setTodo(e.target.value)} />
